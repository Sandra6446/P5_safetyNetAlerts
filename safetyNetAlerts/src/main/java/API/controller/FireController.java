...
public class FireController {
    ...
    /**
     * Returns all the inhabitants living at the given address and the number of the firestation serving it
     *
     ...
     */
    @ApiOperation(value = "Returns all the inhabitants living at the given address and the number of the firestation serving it")
    @GetMapping
    public MappingJacksonValue getDataPerAddress(@RequestParam("address") String address) throws Exception {
